  ...
  return (
    <>
      {isPersonalProfile ? (
        <Link
          href={pathname + '/edit'}
          className="border-primary-500 bg-primary-500 text-white-100 inline-flex w-full items-center justify-center gap-2.5 rounded-lg border py-3 text-sm font-bold transition-colors outline-none"
        >
          Edit Profile
        </Link>
      ) : (
